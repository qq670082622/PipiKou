...
- (UIImage *)trackBackgroundImage
{
    ...
    {
        UIImage* image = [UIImage imageNamed:@"lightgraybg"];
...
- (UIImage *)trackImage
{
    if(_trackImage==nil)
    {
        UIImage* image = [UIImage imageNamed:@"orangebg"];
...
- (UIImage *)lowerHandleImageNormal
{
    if(_lowerHandleImageNormal==nil)
    {
       // UIImage* image = [UIImage imageNamed:@"slider-default-handle"];
         UIImage* image = [UIImage imageNamed:@"hualun"];
...
- (CGRect)trackRect
{
    ...
    retValue.size = CGSizeMake(_trackImage.size.width, 1);
 ...
 -(CGRect) trackBackgroundRect
{
    ...
    trackBackgroundRect.size = CGSizeMake(_trackBackgroundImage.size.width-4, 1);
    
    if(_trackBackgroundImage.capInsets.top || _trackImage.capInsets.bottom)
    {
    ...
    {
        trackBackgroundRect.size.width=self.bounds.size.width-4-15;
    }
