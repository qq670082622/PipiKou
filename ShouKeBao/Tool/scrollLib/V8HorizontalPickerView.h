...
@interface V8HorizontalPickerView : UIView <UIScrollViewDelegate,V8HorizontalPickerViewDelegate, V8HorizontalPickerViewDataSource>
{ }
...
/*************************************************************************/
@property(nonatomic,retain) NSArray* _arrayOptions  ;
...
/*********************************************************************/
// id<OptionsPanelDelegate> deleage ;
// @property(assign,nonatomic)id<OptionsPanelDelegate> delegate ;
