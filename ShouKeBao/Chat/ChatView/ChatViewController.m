...
- (DXMessageToolBar *)chatToolBar
{
    if (_chatToolBar == nil) {
        ...
        _chatToolBar.moreView.backgroundColor = [UIColor colorWithRed:248/255.0 green:248/255.0 blue:248/255.0 alpha:1];
...
//            voice.localPath = [recordPath stringByReplacingOccurrencesOfString:@"amr" withString:@"wav"];
//            voice.fileLength = [self fileSizeAtPath:[recordPath stringByReplacingOccurrencesOfString:@"amr" withString:@"wav"]];
            NSLog(@"%@", voice);
